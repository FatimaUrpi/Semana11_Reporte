...
@Controller
/*parael archivoe pdf de reporte*/
@CommonsLog
...
public class EmpleadoConsultaController {
	...
	@ResponseBody
	public List<Empleado> consulta(int estado, int idPais, String nomApe, String fecDesde,
			String fecHasta){
		List<Empleado> lstSalida = service.listaConsultaEmpleado(estado, idPais,
				"%"+ nomApe +"%", Date.valueOf(fecDesde),  Date.valueOf(fecHasta));
		return lstSalida;
	}
